...
template void draw_polygons_filled<unsigned char>(matrix_color<unsigned char> *img, std::vector<vertex> *vertices, std::vector<polygon> *polygons, int scale, int offset);
template void draw_polygons_filled<color_rgb>(matrix_color<color_rgb> *img, std::vector<vertex> *vertices, std::vector<polygon> *polygons, int scale, int offset);
